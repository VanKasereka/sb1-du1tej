...
const AddMoneySuccessPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm text-center">
        ...
        <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Money Added Successfully</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">Your account has been credited with the specified amount.</p>
        <Link
          to="/"
